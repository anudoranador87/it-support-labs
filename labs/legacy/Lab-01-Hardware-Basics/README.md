...
**Evidencia:** pendiente de incorporar la captura de la inspección física.
...
**Evidencia:** pendiente de incorporar la captura de BIOS/UEFI.
...
**Evidencia:** pendiente de incorporar la captura de información del sistema.
